shooter: shooter.o engine.o ship.o enemy.o player_projectile.o enemy_projectile.o projectile_manager.o
	g++ -g -o shooter shooter.o engine.o ship.o enemy.o player_projectile.o enemy_projectile.o projectile_manager.o `sdl2-config --libs` -lSDL2_image
